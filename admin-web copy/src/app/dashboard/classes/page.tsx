            ...
            <div className="p-5 border-b border-[var(--color-border)] bg-black/5 dark:bg-white/5/50 space-y-4">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-9 pr-4 py-2 glass-card border border-[var(--color-border)] rounded-xl text-sm focus:outline-none focus:border-interactive-blue transition-colors"
                />
              </div>
            </div>
                ...
                <div className="space-y-1 p-1">
                  {filteredClasses.map(c => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-3.5 rounded-xl font-medium transition-all flex items-center justify-between group ${selectedClassId === c.id ? 'bg-interactive-blue text-white shadow-md' : 'hover:bg-black/5 dark:bg-white/5 border border-transparent hover:border-[var(--color-border)] text-[var(--color-text-primary)]'}`}
                    >
              ...
              <div className="md:hidden border-b border-[var(--color-border)] glass-card sticky top-0 z-10 flex overflow-x-auto snap-x hide-scrollbar">
                {daysOfWeek.map(day => (
                  <button
                    ...
                    className={`px-6 py-4 font-bold text-sm whitespace-nowrap snap-start transition-colors relative ${selectedDay === day ? 'text-interactive-blue' : 'text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)]'}`}
                  >
                    {day}
                    {selectedDay === day && (
              ...
              <div className="p-6 space-y-5">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 border-[var(--color-border)] focus:outline-none focus:border-interactive-blue transition-colors font-medium text-[var(--color-text-primary)]"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 border-[var(--color-border)] focus:outline-none focus:border-interactive-blue transition-colors font-medium text-[var(--color-text-primary)] glass-card appearance-none cursor-pointer"
                  >
