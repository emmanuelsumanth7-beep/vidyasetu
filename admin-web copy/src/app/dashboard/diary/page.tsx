...
/* ── MOCK DATA ────────────────────────────────────────────────────────────── */
const MOCK_PENDING = [
  { id: 'pc1', subject: 'Mathematics', className: '8A', time: '10:00 AM - 10:45 AM', status: 'just_ended' },
  { id: 'pc2', subject: 'Physics',     className: '9B', time: '11:00 AM - 11:45 AM', status: 'just_ended' },
];
...
const DEMO_ENTRIES: DiaryEntry[] = [
  {
    ...
    class: { id: 'c1', name: '8A' },
    subject: 'Mathematics',
    content: 'Completed Chapter 4: Algebraic Expressions. Homework: Ex 4.2 Q1 to Q5.',
    date: new Date().toISOString(),
    teacher: { name: 'Priya K.' }
  },
  {
    id: 'de2',
    class: { id: 'c2', name: '9B' },
    subject: 'Science',
    content: 'Discussed Newton\'s Laws of Motion. Please bring lab coats tomorrow.',
    date: new Date(Date.now() - 86400000).toISOString(),
    teacher: { name: 'Rahul S.' }
  }
];
