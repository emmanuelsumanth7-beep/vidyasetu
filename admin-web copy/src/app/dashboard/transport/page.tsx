                ...
                {BUS_ROUTES.map(route => {
                  ...
                  return (
                    <div key={route.id} onClick={() => setSelectedRoute(route)}
                         ...
                         style={{ 
                           borderLeftColor: route.status === 'delayed' ? '#FF9500' : route.status === 'arrived' ? '#34C759' : '#007AFF',
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-[9px] font-black uppercase tracking-widest px-2 py-1 rounded-md" 
                              style={{ background: route.status === 'delayed' ? 'rgba(255,149,0,0.1)' : 'rgba(0,122,255,0.1)', 
                                       color: route.status === 'delayed' ? '#FF9500' : '#007AFF' }}>
                          {route.id}
                        </span>
                      </div>
