  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: SchoolConfig.logoPath ? 'transparent' : 'linear-gradient(135deg,#007AFF,#5856D6)', boxShadow: SchoolConfig.logoPath ? 'none' : '0 6px 20px rgba(0,122,255,0.35)' }}
      >
