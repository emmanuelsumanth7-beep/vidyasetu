      ...
      {activeTab === 'queue' && (
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="xl:col-span-1 space-y-4">
            ...
            <div className="space-y-3">
              {ACTIVE_HOMEWORKS.length === 0 && (
                <div className="p-4 text-center text-sm font-bold opacity-50" style={{ color: 'var(--color-text-secondary)' }}>No active homework</div>
              )}
          ...
          <div className="xl:col-span-2 space-y-6">
            {!selectedHw ? (
               <div className="glass-card p-10 text-center opacity-50 font-bold" style={{ color: 'var(--color-text-secondary)' }}>
