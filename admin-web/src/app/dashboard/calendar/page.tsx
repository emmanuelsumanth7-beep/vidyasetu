        ...
        {activeTab === 'academic' && (
          <motion.div key="academic" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-6">
                      ...
                      <div key={dateNum} 
                        ...
                        <div className="absolute bottom-2 left-2 right-2 flex flex-col gap-1">
                          {dayEvents.map(event => {
                            ...
                            if (event.type === 'event')   { bg = 'rgba(27,42,74,0.15)'; color = '#1B2A4A'; }
            ...
            <div className="flex flex-wrap items-center gap-4 px-2">
              ...
              <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full" style={{ background: '#1B2A4A' }} /> <span className="text-xs font-bold" style={{ color: 'var(--color-text-secondary)' }}>Events</span></div>
